package com.atakmap.android.harrissaspr.util;
...
public class SerialInputOutputManager implements Runnable {
    ...
    private static final String TAG = com.atakmap.android.harrissaspr.util.SerialInputOutputManager.class.getSimpleName();
